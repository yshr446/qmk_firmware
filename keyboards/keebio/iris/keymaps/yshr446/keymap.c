...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
     LSFT, Z  , X  , C  , V  , B  ,SPC ,     SPC , N  , M  ,COMM,DOT ,SLSH,RSFT,
  //`----+----+----+--+-+----+----+----/    \----+----+----+----+----+----+----'
  ...
  //,----+----+----+----+----+----.              ,----+----+----+----+----+----.
         ,    ,    ,    ,    ,    ,                   ,    ,    ,   ,     ,    ,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
     PMNS,EXLM, AT ,HASH,DLR ,PERC,               CIRC,AMPR,ASTR,LPRN,RPRN,UNDS,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
         ,    ,    ,    ,    ,    ,               PLUS,PEQL,LCBR,RCBR,COLN,DQUO,
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
         ,     ,    ,    ,    ,    ,    ,    RPRN,PIPE,GRV ,LBRC,RBRC,QUES,BSLS,
  //`---- +----+----+--+-+----+----+----/   \----+----+----+----+----+----+----'
                           ,    ,    ,             ,    ,
  //                  `----+----+----'        `----+----+----'
  ),
